...
<nav class="w3-sidebar w3-black w3-animate-right w3-xxlarge" style={{display:"none",paddingTop:"150px",right:"0",zIndex:"2"}} id="mySidebar">
  ...
  <div class="w3-bar-block w3-center">
    ...
    <a href="#" class="w3-bar-item w3-button w3-text-grey w3-hover-black" onclick="closeNav()">Portfolio</a>
    <a href="#" class="w3-bar-item w3-button w3-text-grey w3-hover-black" onclick="closeNav()">About</a>
    <a href="#" class="w3-bar-item w3-button w3-text-grey w3-hover-black" onclick="closeNav()">Contact</a>
  </div>
</nav>
...
<div class="w3-main w3-padding-large" style={{marginLeft:"40%"}}>
  ...
  <header class="w3-container w3-center" style={{padding:"128px 16px"}} id="home">
    ...
    <img src="/w3images/profile_girl.jpg" class="w3-image w3-hide-large w3-hide-small w3-round" style={{display:"block" , width:"60%" , margin:"auto"}} alt=''/>
    <img src="/w3images/profile_girl.jpg" class="w3-image w3-hide-large w3-hide-medium w3-round" width="1000" height="1333" alt=''/>
  ...
  <div class="w3-padding-32 w3-content" id="portfolio">
    ...
    <div class="w3-row-padding" style={{margin:"0 -16px"}}>
      <div class="w3-half">
        <img src="/w3images/wedding.jpg" style={{width:"100%"}} alt=''/>
        <img src="/w3images/rocks.jpg" style={{width:"100%"}} alt=''/>
        <img src="/w3images/sailboat.jpg" style={{width:"100%"}} alt=''/>
      </div>

      <div class="w3-half">
        <img src="/w3images/underwater.jpg" style={{width:"100%"}} alt=''/>
        <img src="/w3images/chef.jpg" style={{width:"100%"}} alt=''/>
        <img src="/w3images/wedding.jpg" style={{width:"100%"}} alt=''/>
        <img src="/w3images/p6.jpg" style={{width:"100%"}} alt=''/>
      </div>
    {/* <!-- End photo grid --> */}
    </div>
  ...
  <div class="w3-padding-32 w3-content w3-text-grey" id="contact" style={{marginBottom:"64px"}}>
    ...
    <img src="/w3images/map.jpg" class="w3-image w3-greyscale" style={{width:"100%" , margin:"32px 0"}} alt=''/>
  ...
  <footer class="w3-container w3-padding-64 w3-light-grey w3-center w3-opacity w3-xlarge" style={{margin:"-24px"}}>
    ...
    <p class="w3-medium">Powered by <a href="https://www.w3schools.com/w3css/default.asp" target="#" class="w3-hover-text-green">w3.css</a></p>
  {/* <!-- End footer --> */}
  </footer>
